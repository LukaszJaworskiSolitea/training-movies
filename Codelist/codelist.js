    ...
    (function (api) {
        ...
        (function (codelist) {
            var CodelistApi = /** @class */ (function () {
                ...
                CodelistApi.prototype.getLookupData = function (startString, attributeName, useContains, expectLinebreaksInValues, relevantDate, resultSorting, fixedODataFilter) {
                    return this.core.getLookupData(startString, attributeName, useContains, expectLinebreaksInValues, relevantDate, resultSorting, fixedODataFilter);
                };
    ...
    (function (api) {
        ...
        (function (codelist) {
            var CodelistCore = /** @class */ (function () {
                ...
                CodelistCore.prototype.getLookupData = function (startString, attNamePar, useContains, expectLinebreaksInValues, relevantDate, resultSorting, fixedODataFilter) {
                    var _this = this;
                    ...
                    if (this.dataLoaded) {
                        ...
                        promiseChain = this.getRemoteLookupData(startString || '', attName, useContains, expectLinebreaksInValues, relevantDate, fixedODataFilter);
                    }
                ...
                CodelistCore.prototype.getRemoteLookupData = function (startString, attName, useContains, expectLinebreaksInValues, relevantDate, fixedODataFilter) {
                    var _this = this;
                    var reqUrl = new codelist.CodelistReqUrl({
                        codelistsUrl: this.server.codelistsUrl,
                        codelistName: this.codelistName,
